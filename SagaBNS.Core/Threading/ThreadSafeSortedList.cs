...
namespace SagaBNS.Core.Threading
{
    /// <summary>
    ...
    public class ThreadSafeSortedList<TK, TV> : IDisposable
    {
        ...
        /// <summary>
        /// Removes an item from collection and returns its object as out parameter.
        /// </summary>
        /// <param name="key">Key of item to remove</param>
        /// <param name="value">out parameter of removed value</param>
        /// <returns><see cref="bool"/> if removed</returns>
        public bool Take(TK key, out TV value)
        {
            if (!_disposed)
            {
                _lock.EnterWriteLock();
